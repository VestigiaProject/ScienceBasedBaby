...
export function enhanceQuery(question: string): EnhancedQuery {
  const userPrompt = `Give the pros and cons (in a large sense: it can also be understood as significant/not significant if it is more relevant to the question) about "${question}" site:https://pubmed.ncbi.nlm.nih.gov/ site:https://jamanetwork.com/ site:https://www.ncbi.nlm.nih.gov/ Format your response EXACTLY as follows, using these EXACT markers: <PROS>, </PROS>, <CONS>, </CONS>
